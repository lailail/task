...
class OrderResultEventConsumerTest {
    ...
    void should_delegate_order_result_event_to_reservation_confirm_service() {
        OrderResultEventConsumer consumer = new OrderResultEventConsumer(
                reservationConfirmService,
                reservationReleaseTriggerService
        );
        ...
        verify(reservationReleaseTriggerService).handleOrderCreateResult(event);
    }
}
